...
def register_highway_envs():
    ...
    register(
        id='safe-highway-fast-v0',
        entry_point='highway_env.envs:SafeHighwayEnvFast',
    )

    register(
        id='safe-intersection-v0',
        entry_point='highway_env.envs:safeIntersectionEnv',
    )

    # safeIntersectionEnv
    register(
        id='safe-intersection-v1',
        entry_point='highway_env.envs:safeContinuousIntersectionEnv',
    )

    register(
        id='safe-merge-v0',
        entry_point='highway_env.envs:SafeMergeEnv',
    )